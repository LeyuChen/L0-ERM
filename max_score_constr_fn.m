...
%         set q = 0 for unconstrained estimation
...
function [bhat,score,gap,rtime,ncount] = max_score_constr_fn(y,x_foc,x_aux,beta0,q,T,abgap,bnd)
...
miobnd=miobnd_fn([x_foc x_aux],beta0,bnd); % Compute the terms M(i) in the MILP formulation
