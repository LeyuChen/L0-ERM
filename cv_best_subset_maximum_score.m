...
% This function computes the optimal cardinality bound for the L0-constrained maximum score estimation 
% among a range of tuning values specified by the vector q_range via the cross-validation procedure.
...
[bhat(:,i,q),score(i,q),gap(i,q),rtime(i,q),ncount(i,q)]  = max_score_constr_fn(y,datax(:,focus_ind),datax(:,aux_ind),beta0,q_range(q),T,tol,bnd);
